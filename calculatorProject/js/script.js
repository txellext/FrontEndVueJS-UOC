...
function evenOddNum1Num2(num1, num2) {
  if ((num1 % 2 == 0) & (num2 % 2 == 0)) {
    ...
    //alert(num1 + " and " + num2 + " ara even numbers");
  } else if ((num1 % 2 == 0) & (num2 % 2 != 0)) {
    console.log(num1 + " is an even number and " + num2 + " is an odd number");
    //alert(num1 + " is an even number and " + num2 + " is an odd number");
  } else if ((num1 % 2 != 0) & (num2 % 2 == 0)) {
    console.log(num2 + " is an even number and " + num1 + " is an odd number");
    //alert(num2 + " is an even number and " + num1 + " is an odd number");
  } else {
    console.log("Both " + num1 + "and " + num2 + " are odd numbers");
    //alert("Both " + num1 + "and " + num2 + " are odd numbers");
  }
}
...
// Call functions (calculation function)
